  ...
  SYSTEM
                       SHEET,AT(5,5,390,120),USE(?Sheet),IMM
                         TAB('General'),USE(?TAB1)
                           PROMPT('Description'),AT(10,20),USE(?szDescription:Prompt),FONT(,,COLOR:RoyalBlue,FONT:bold), |
  TRN
                           ENTRY(@s255),AT(55,20,330,10),USE(szDescription),FONT(,,,FONT:regular)
                           PROMPT('File Patterns'),AT(10,30),USE(?FilePatterns:Prompt),FONT(,,COLOR:RoyalBlue,FONT:bold), |
  TRN
